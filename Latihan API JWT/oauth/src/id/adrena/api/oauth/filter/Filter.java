...
public class Filter implements ContainerRequestFilter{
	...
	private static final String UNSECURE_URL_2 = ".well-known";
	private static final String UNSECURE_URL_3 = "refresh";
	...
	public void filter(ContainerRequestContext requestContext) throws IOException {
		...
		if (requestContext.getUriInfo().getPath().contains(UNSECURED_URL)
				|| requestContext.getUriInfo().getPath().contains(UNSECURE_URL_2)
				|| requestContext.getUriInfo().getPath().contains(UNSECURE_URL_3)) {
